    ...
    <footer className="ftwrap" role="contentinfo" aria-label="Site Footer"><div className="ft">
        <div className="fttop">
          <div>
            ...
            <div className="ftsocs">{["📘","📸","🐦","💬","▶️"].map((s,i)=><a key={i} className="fsoc" href="https://matchticket.in">{s}</a>)}</div>
        ...
        <div style={{background:"rgba(202,255,0,.05)",border:"1px solid var(--lime3)",borderRadius:10,padding:"12px 20px",marginBottom:16,display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:8}}>
          ...
          <div style={{fontSize:12,color:"var(--muted)"}}>As per IT Rules 2021 · <button onClick={()=>navigate("grievance")} style={{background:"none",border:"none",cursor:"pointer",color:"var(--lime)",fontSize:12,fontWeight:700,fontFamily:"var(--B)",padding:0}}>grievance@matchticket.in</button> · +91 89402 61212</div>
