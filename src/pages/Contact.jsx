...
function Contact() {
  ...
  const PLAYER_INFO=[
    {ico:"💬",t:"WhatsApp Support",v:"+91 89402 61212 — fastest response"},
  ...
  const OWNER_INFO=[
    {ico:"📞",t:"Owner Success Team",v:"+91 89402 61212 — call or WhatsApp"},
  ...
  const FAQS=[
    ...
    {q:"What if I have a problem with my booking?",a:"WhatsApp us at +91 89402 61212 — we respond in under 2 hours, 7 days a week, 8 AM to 10 PM. Refunds are processed automatically per policy."},
        ...
        <div className="split" style={{gap:56}}>
          <div>
            ...
            <div style={{marginTop:24,display:"flex",gap:12,flexWrap:"wrap"}}>
              <button className="bl" style={{padding:"13px 26px"}}>💬 WhatsApp Now</button>
              <button className="bo" style={{padding:"13px 22px"}}>📧 Send Email</button>
            </div>
          </div>
          <div>
            {sent?(
              ...
              <div style={{background:"var(--card2)",border:"1px solid var(--border)",borderRadius:22,padding:36}}>
                ...
                <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:14,marginBottom:14}}>
                  ...
                  <div><label className="flbl">Mobile</label><input className="fin" placeholder="+91 89402 61212" value={form.phone} onChange={e=>setF("phone",e.target.value)}/></div>
                </div>
